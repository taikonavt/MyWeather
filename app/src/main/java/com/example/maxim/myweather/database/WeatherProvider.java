...
public class WeatherProvider extends ContentProvider {
    ...
    public static final int CODE_CURRENT_PLACE = 400;
    public static final int CODE_FAVOURITE_PLACE = 100;
    public static final int CODE_FAVOURITE_PLACE_WITH_ID = 101;
    public static final int CODE_TODAY_WEATHER = 200;
    public static final int CODE_TODAY_WEATHER_FOR_PLACE = 201;
    public static final int CODE_FORECAST_WEATHER = 300;
    public static final int CODE_FORECAST_WEATHER_FOR_PLACE = 301;
    ...
    public static UriMatcher buildUriMatcher(){
        ...
        matcher.addURI(authority, Contract.PATH_CURRENT_PLACE, CODE_CURRENT_PLACE);
        matcher.addURI(authority, Contract.PATH_FAVOURITE_PLACE, CODE_FAVOURITE_PLACE);
        matcher.addURI(authority, Contract.PATH_FAVOURITE_PLACE + "/#", CODE_FAVOURITE_PLACE_WITH_ID);
...
//        matcher.addURI(authority, Contract.PATH_TODAY + "/#", CODE_TODAY_WEATHER_FOR_LOCATION);
        matcher.addURI(authority, Contract.PATH_FORECAST + "/#", CODE_FORECAST_WEATHER_FOR_PLACE);
        return matcher;
    }
